...
import cmy.project.lib_base.R
import cmy.project.lib_base.databinding.AbsListLayoutBinding
...
abstract class AbsListActivity <T, V : AbsListViewModel<T>> : AppCompatActivity(),
    ...
    private fun initViewModel() {
        //kotlin + koin
        val clazz = this.javaClass.kotlin.supertypes[0].arguments[1].type!!.classifier!! as KClass<V>
